...
public class Vistaa extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        impresion.setBackground(new java.awt.Color(0, 255, 51));
        impresion.setColumns(20);
        impresion.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        impresion.setRows(5);
        impresion.setBorder(javax.swing.BorderFactory.createTitledBorder("Resultados de operaciones"));
        impresion.setOpaque(false);
        impresion.addAncestorListener(new javax.swing.event.AncestorListener() {
            public void ancestorMoved(javax.swing.event.AncestorEvent evt) {
            }
            public void ancestorAdded(javax.swing.event.AncestorEvent evt) {
                impresionAncestorAdded(evt);
            }
    ...
    private void impresionAncestorAdded(javax.swing.event.AncestorEvent evt) {//GEN-FIRST:event_impresionAncestorAdded
       
    }//GEN-LAST:event_impresionAncestorAdded
